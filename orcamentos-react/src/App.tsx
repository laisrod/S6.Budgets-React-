...
export default function App() {
  ...
  const websiteAdditional = useMemo(() => {
    return isWebsiteSelected ? (websitePages + websiteLanguages) * 30 : 0
  }, [isWebsiteSelected, websitePages, websiteLanguages])
    ...
    <div className="container">
      ...
      {isWebsiteSelected && (
        <WebsiteOptions
          ...
          onPagesChange={v => setWebsitePages(Math.max(1, v))}
          onLanguagesChange={v => setWebsiteLanguages(Math.max(1, v))}
        />
      )}
